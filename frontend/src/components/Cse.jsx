...
const Cse = ({isAuth, authSetter}) => {
    ...
    useEffect(() => {
        getSubmissions("/submission/CSE/All/null");
      }, []);
  ...
  return (
    ...
    <div className="row mt-2">
      ...
      <div className="col-md-6">
        <Card title="Submission Of CSE Department" bodyStyle={{padding:"12px"}}>
                            ...
                            <Button
                              onClick={() => {
                                updateStatus(
                                  ...
                                  () => {
                                    getSubmissions(
                                      `/submission/CSE/${batch?.label === "All"
                                        ? "All"
                                        : batch
                                      }/null`
                                    );
