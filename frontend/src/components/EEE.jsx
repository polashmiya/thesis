...
const EEE = ({isAuth, authSetter}) => {
    ...
    useEffect(() => {
        getSubmissions("/submission/EEE/All/null");
      }, []);
  ...
  return (
    ...
    <div className="row mt-2">
      ...
      <div className="col-md-6">
        <Card title="Submission Of EEE Department" bodyStyle={{padding:"12px"}}>
                            ...
                            <Button
                              onClick={() => {
                                updateStatus(
                                  ...
                                  () => {
                                    getSubmissions(
                                      `/submission/EEE/${batch?.label === "All"
                                        ? "All"
                                        : batch
                                      }/null`
                                    );
